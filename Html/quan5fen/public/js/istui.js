$(function()
{
    ...
    $.ajax({
        type:'post',
        url:'index.php?m=www&c=user&a=ajax_user_get_goods_list_tuiguang_status',
        data:{'id':list},
        dataType:'json',
        cache:false,
    ...
    var copyFun = function (obj)
    {
        ...
        {
            var url='/index.php?m=www&c=user&a=ajax_get_goods_wenan&id='+ obj.siblings('.go_info').data('gid') ;
            $.ajax({
                type:'get',
                url:url,
                cache:false,
