...
<style>
    .nContItemNet .pt8 a{font-size: 16px;}
/*    .nContItemNet .pt8 a:hover{color: orangered;text-decoration: underline;}*/
    .nContItemNet .FTCOr {font-size: 14px;}
</style>
<!--indexCom-->
<section class="indexCom mt30" id="indexCom">
                ...
                <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><div class="nContItemNet clearfix pdNshare">
                        <div>
                            <p class="clearfix pb12 pt8">
                                <a href="<?php echo U('Content/goodShare',array('main'=>$v['id']));?>" class="fl"><i class="iconfont icon-ganhuofenxiang"></i> <?php echo ($v['title']); ?></a>
