    ...
    <div class="myItem">
        ...
        <div class="myRight fr">
            ...
            <div class="com bankcard">
                ...
                <ul>
                    <li>
                        <?php if($data): if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><div class="item">
                                    ...
                                    <span class="ti02"><?php echo ($v['mobile']); ?></span>
                                    <span class="ti03"><?php echo ($v['province']); echo ($v['city']); echo ($v['county']); echo htmlspecialchars_decode($v['address']);?></span>
                                    <div class="ti04 han">
                                        <a href="javascript:;" class="del del-btn"  delete-id="<?php echo ($v['id']); ?>">
                                            <i></i><span>删除</span>
                                        </a>
                                        <a href="<?php echo U('User/myAddress',array('edit'=>$v['id']));?>" class="chg">
                                            <i></i><span>修改</span>
                                        </a>
                                        <em></em>
                                    </div>
                ...
                <div class="myBtn">
                    <button type="button" class="bbtn" onclick="location.href='<?php echo U('User/myAddress');?>';">添加收货地址</button>
                </div>
...
<script>
    var formActionUrl = "<?php echo U('User/myAddressList');?>";
    //删除收货地址
