    ...
    <div class="myItem">
        ...
        <div class="myRight fr">
            ...
            <div class="com safety">
                <ul>
                    <li class="item <?php echo ($user_info['mobile']?'bind':''); ?>">
                        <div class="ti01">
                            <img src="/Public/Member/images/aqIco01.png">
                            <span>手机绑定</span>
                        </div>
                        <div class="ti02">
                        ...
                        <div class="ti03">
                            <span><i></i><?php echo ($user_info['mobile']?'已绑定':'未绑定'); ?></span>
                        </div>
                        <div class="ti04">
                            <a href="<?php echo U('Safe/verify');?>?type=phone">更换</a>
                        </div>
                    </li>
                    <li class="item <?php echo ($user_info['email']?'bind':''); ?>">
                        <div class="ti01">
                            <img src="/Public/Member/images/aqIco02.png">
                            <span>邮箱绑定</span>
                        </div>
                        <div class="ti02">
                            <span><?php echo ($user_info['email']?substr_replace($user_info['email'],'****',3,4):'绑定后可用于找回密码'); ?></span>
                        </div>
                        <div class="ti03">
                            <span><i></i><?php echo ($user_info['email']?'已绑定':'未绑定'); ?></span>
                        </div>
                        <div class="ti04">
                            <a href="<?php echo U('Safe/verify');?>?type=email"><?php echo ($user_info['email']?'更换':'绑定'); ?></a>
                        </div>
                    </li>
                    <li class="item <?php echo ($user_info['weixin_openid'] && $user_info['weixin_unionid']?'bind':''); ?>">
                        <div class="ti01">
                            <img src="/Public/Member/images/aqIco03.png">
                            <span>微信绑定</span>
                        </div>
                        <div class="ti02">
                        ...
                        <div class="ti03">
                            <span><i></i><?php echo ($user_info['weixin_openid'] && $user_info['weixin_unionid']?'已绑定':'未绑定'); ?></span>
                        </div>
                        <div class="ti04">
                            <a href="<?php echo U('Safe/weixin');?>"><?php echo ($user_info['weixin_openid'] && $user_info['weixin_unionid']?'解绑':'绑定'); ?></a>
                        </div>
                    </li>
                    <li class="item <?php echo ($user_info['password'] && $user_info['encrypt']?'bind':''); ?>">
                        <div class="ti01">
                            <img src="/Public/Member/images/aqIco04.png">
                            <span>修改密码</span>
                        </div>
                        <div class="ti02">
                        ...
                        <div class="ti03">
                            <span><i></i><?php echo ($user_info['password'] && $user_info['encrypt']?'已设置':'未设置'); ?></span>
                        </div>
                        <div class="ti04">
                            <a href="<?php echo U('Safe/password');?>">修改</a>
                        </div>
                    </li>
                    <li class="item <?php echo ($bankCard?'bind':''); ?>">
                        <div class="ti01">
                            <img src="/Public/Member/images/aqIco05.png">
                            <span>银行卡绑定</span>
                        </div>
                        <div class="ti02">
                        ...
                        <div class="ti03">
                            <span><i></i><?php echo ($bankCard?'已绑定':'未绑定'); ?></span>
                        </div>
                        <div class="ti04">
                            <a href="<?php echo U('Safe/myBankList');?>"><?php echo ($bankCard?'修改':'绑定'); ?></a>
                        </div>
                    </li>
                </ul>
            </div>
