                ...
                <div class="elList">
                    <ul>
                        <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><li>
                                <div class="item">
                                    <div class="tp">
                                        <?php if($v['cover_img']): ?><img src="<?php echo ($v['cover_img']); ?>" alt="图片">
                                        <?php else: ?>
                                            <img src="/Public/Member/images/stu01.jpg" alt="图片"><?php endif; ?>
                                    </div>
                                    <div class="txt">
                                        <h4 class="tiName"><?php echo ($v['title']); ?></h4>
                                        <div class="wz js-wz" data-html="" data-staus=""><?php echo htmlspecialchars_decode($v['content']);?>
                                        </div>
                                    </div>
                                </div>
