...
<section class="indexCom mt32" id="indexCom">
    ...
    <ul class="pb30">
        <li>
            <a <?php echo ACTION_NAME=='index'?'class="coR cur"':'';?> href="<?php echo U('Content/index');?>"><em ></em><span>公司简介</span><i class="iconfont icon-xiala-copy-copy"></i></a>
        </li>
        <li <?php echo ACTION_NAME=='contactUs'?'class="coR cur"':'';?>>
            <a href="<?php echo U('Content/contactUs');?>"><em ></em><span>联系我们</span><i class="iconfont icon-xiala-copy-copy"></i></a>
        </li>
        ...
        <div class="noticeRigth fr  ml15 pb50">
            <p class="p pl50">
                <span class="fonts18 textColor"><?php echo ($position_name); ?></span>
            </p>
            <div class="nContent  fonts17 pb50 ">
                <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><div class="nContItemNet clearfix pdNshare">
                        <div>
                            <p class="clearfix pb12 pt8">
                                <a href="<?php echo U('Content/webNotice',array('main'=>$v['id']));?>" class="fl"><i class="iconfont icon-ganhuofenxiang"></i> <?php echo ($v['title']); ?></a>
                                <span class="fr FTCOr"><?php echo date('Y-m-d',$v['addtime']);?></span>
                            </p>
                            <p class="FTCOr" style="width: 80%;">
                                <?php echo jiequ(strip_tags(htmlspecialchars_decode($v['content'])),0,100,'...');?>
                            </p>
                        </div>
