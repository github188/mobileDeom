    ...
    <div class="webLogin" id="web_qr_login">
        ...
        <div class="WebBlock tabDiv">
            <div class="panel-body padder-md">
                <form action="<?php echo U('Login/index');?>" method="post" name="myForm" id="loginMyForm" data-validator-option="{stopOnError:true}" autocomplete="off" >
                  <div class="error"></div>
                    ...
                    <div class="input-group borderNone">
                        ...
                        <img src="<?php echo U('Login/verify');?>" id="captcha_img" alt="验证码" height="38" width="120" class="ml18"  onclick="">
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <a class="pull-right text ft13 mr14 fr" target="_self" href="<?php echo U('Login/passwordWay');?>">忘记密码？</a>
                    </div>
            ...
            <div class="panel-footer clearfix mb20 textRight">
                <p  class="mr50  clearfix">
                    ...
                    <a href="<?php echo U('Login/register');?>" class="commonColor ft16">立即注册</a>
                </p>
            </div>
        </div>
        ...
        <div style="display: none" class="tabDiv">
            ...
            <!--<img src="/Public/Member/images/wx_login.png" alt="" class="wxLogin">-->
