...
<!--myCourse-->
<section class="myCom myCourse" id="myCourse">
    <div class="in w1100 m0a">
        <!--左侧共用菜单-->
        <div class="myLeft fl">
    <div class="myLHd">
        ...
        <div class="myRight fr">
            <div class="rHd">
                <div class="hdTit">
                    ...
                    <i></i>
                    <a href="javascript:;">报名课程</a>
                </div>
            </div>
            <div class="com accCom">
                <ol>
                    <li class="ti01"><span>账号类型</span></li>
                    <li class="ti02"><span>开通时间</span></li>
                    <li class="ti03"><span>过期时间</span></li>
                    <li class="ti04"><span></span></li>
                </ol>
                <ul>
                    <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><li>
                            <div class="item">
                                <span class="ti01"><img style="display: inline-block;border-radius: 3px;" src="/Public/Member/images/user_group/<?php echo ($v['group_id']); ?>.png" width="18px" height="18px" alt="图片"/>&nbsp;&nbsp;<?php echo ($v['group_name']); ?></span>
                                <span class="ti02"><?php echo date('Y-m-d',$v['start_time']);?></span>
                                <span class="ti03"><?php echo date('Y-m-d',$v['end_time']);?> <?php if($v['end_time'] < time()): ?><em style="color: red;">(已过期)</em><?php endif; ?></span>
                                <span class="ti04"><s class="jt"></s></span>
                            </div>
                            <div class="xlItem">
                                <div class="itBot">
                                    <div class="bb">
                                        <span class="ti01"><a href="javascript:;"><img src="/Public/Member/images/ico-shipin.png">新人学习知道</a> </span>
                                        <span class="ti05">
                                            <div class="progess">
                                                <div class="maxPro">
                                                    <p class="curPro" style="width: 50%;"></p>
                                                </div>
                                                <em class="proNum">50%</em>
                                            </div>
                                        </span>
                                    </div>
                                    <div class="bb">
                                    ...
                                    <div class="bb">
                                        <span class="ti01"><a href="javascript:;"><img src="/Public/Member/images/ico-suo.png">新人学习知道</a></span>
                                        <span class="ti05">
                                            <div class="progess">
                                                <div class="maxPro">
                                                    <p class="curPro" style="width: 50%;"></p>
                ...
                <div class="myBtn upBtn">
                    <button type="button"  class="bbtn"  onclick="location.href='<?php echo U('Pay/courseChoose');?>';">升级账号</button>
                </div>
            </div>
        </div>
    </div>
