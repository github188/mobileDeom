                        ...
                        <ul>
                            <li>
                                <div class="inp">
                                    ...
                                    <input type="text" id="oldPwd" placeholder="请输入原密码" maxlength="16" name="old_pwd" data-rule="原密码: required;">
                                    <p class="tip"></p>
                                </div>
                            </li>
                            <li>
                                <div class="inp">
                                    ...
                                    <input type="text" id="newPwd" placeholder="请输入登录密码，6-16个字符" maxlength="16" name="pwd" data-rule="密码: required;password;length(6~16);">
                                    <p class="tip2"></p>
                                </div>
                            </li>
                            <li>
                                <div class="inp">
                                    ...
                                    <input type="text" id="newPwds" placeholder="请再次输入登录密码" maxlength="16" name="confirm_pwd" data-rule="确认密码: match(pwd);">
                                    <p class="tip3"></p>
                                </div>
                            </li>
                        </ul>
                        <p style="text-align: center;text-indent: 74px;"><a href="<?php echo U('Login/passwordWay');?>">忘记密码？</a></p>
...
<script>
    var formActionUrl = "<?php echo U('Safe/password');?>";
    var successUrl    = "<?php echo U('Safe/securityList');?>";
    //提交表单
