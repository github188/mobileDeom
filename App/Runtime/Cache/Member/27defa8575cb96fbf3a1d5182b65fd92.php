                            ...
                            <ul id="questionlist" data-last-question-id="<?php echo ($question["end_id"]); ?>">
                                ...
                                <?php if(is_array($question["question"])): foreach($question["question"] as $k=>$val): ?><li>
                                        <div data-last-answer-id="<?php echo ($val["limit_end_id"]); ?>" class="item question_list">
                                            ...
                                            <span>
                                                ...
                                                <a href="/Member/Video/showList/category/<?php echo ($val["category_id"]); ?>"><?php echo ($val["category_name"]); ?>/</a><a href="/Member/Video/play/vid/<?php echo ($val["vid"]); ?>"><?php echo ($val["video_name"]); ?></a>
                                                    ...
                                                    <div class="hand handLi clearfix">
                                                        ...
                                                        <span onclick="shoucang($(this), <?php echo ($val["id"]); ?>, 1)" class="sc1 fr ml110"><em class="videoEms active"></em><i class="fonts14"><i>取消</i></i></span>
                                                        <a href="javascript:;" onclick="createBox($(this))" class="mesIco mesIcoT"><i></i>(<span class="reply_count"><?php echo ($val["count"]); ?></span>)</a>
                                                    </div>
                                            ...
                                            <!--查看更多-->
                                            <?php if(!empty($val["is_show_more"])): ?><a data-limit-end-id="<?php echo ($val["limit_end_id"]); ?>" onclick="answer_page($(this), <?php echo ($val["id"]); ?>, <?php echo ($user_id); ?>)" style="display:block; margin-left: 80px; margin-top:25px; text-align: left;cursor:pointer;color: rgba(102, 102, 102, 0.65);">查看更多</a><?php endif; ?>
                                        </div>
                                    </li><?php endforeach; endif; ?>

                                <?php if(!empty($question["is_show_more"])): ?><div class="bgColor textAlign mt-10">
                                        <a data-is-shoucang="1" data-last-limit-id="<?php echo ($question["limit_end_id"]); ?>" class="Hmore m0a" onclick="question_page($(this), <?php echo ($user_id); ?>)">点击加载更多</a>
                                    </div><?php endif; ?>
                            </ul>
                        </div>
                    </div>
