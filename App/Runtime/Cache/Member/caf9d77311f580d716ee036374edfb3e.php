                ...
                <div class="layui-tab-item layui-show learnCourese bgColor m0a">
                    ...
                    <div class="conditions">
                        <ul class="condList clearfix ul1">
                            <p>付款方式：</p>
                            <li class="dofunc"><span>全部</span></li>
                            <li class=" dofunc on "><span>免费</span></li>
                            <li class="noon dofunc"><span>付费</span></li>
                            <input type="hidden">
                        </ul>
                        ...
                        <ul class="condList clearfix ul2">
                            <p>推广方式：</p>
                            <li class="dofunc"><span>全部</span></li>
                            <li class="noon dofunc"><span>QQ</span></li>
                            <li class="noon dofunc on"><span>微信</span></li>
                            <li class="noon dofunc"><span>微信</span></li>
                            <li class="noon dofunc"><span>微信</span></li>
                            <input type="hidden">
                        </ul>
                    ...
                    <div class="CoureseBody">
                        ...
                        <?php if(!$video): ?><div style="width: 300px;min-height: 100px;margin: 0 auto 100px;text-align: center;">
