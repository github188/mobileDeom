        ...
        <div class="myRight fr">
            <div class="rHd">
                ...
                <div class="moneyHanle">
                    <div class="mL fl">
                        <span>账户佣金：</span>
                        <span class="ye"><?php echo ($user_account['brokerage']); ?></span>
                    </div>
                    <div class="mR fr">
                        <button class="btn01 btn03" onclick="location.href='<?php echo U('User/myTiXian');?>';">提现</button>
            ...
            <div class="finance mt20">
                ...
                <div class="finRecord">
                            ...
                            <li>
                                <div class="itemIn">
                                    <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><div class="item">
                                            <span class="ti01"><?php echo substr_replace($v['number'],'****',4,strlen($v['number'])-8);?> </span>
                                            <span class="ti02"><?php echo getBankType($v['type']);?></span>
                                            <span class="ti03"><?php echo ($v['money']); ?></span>
                                            <span class="ti04"><?php echo date('Y/m/d H:i',$v['addtime']);?></span>
                                            <span class="ti05"><?php echo ($v['ratify_remark']?htmlspecialchars_decode($v['ratify_remark']):'---'); ?></span>
                                            <span class="ti06">
                    ...
                    <?php if($totalPages > 1): ?><!--分页-->
                        <div class="pages"><?php echo ($pages); ?></div><?php endif; ?>
                </div>
            </div>
        </div>
    </div>
