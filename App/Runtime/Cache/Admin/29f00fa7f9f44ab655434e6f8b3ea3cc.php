        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div id="tab_1" class="tab-pane active">
                    <form style="margin:15px 0px 10px 0px;" class="form-inline display-inline" method="post" action="<?php echo U(MODULE_NAME.'/User/login_log');?>">
                    ...
                    <table id="example" class="table table-bordered table-hover">
                        <thead>
                            <tr class="header" align="center">
                                ...
                                <td width="10%" align="center">登录城市</td>
                            </tr>
                        </thead>
                        <tbody>
                             <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; $login = $log->where(array('user_id'=>$v['id']))->limit(0,10)->order('logintime desc')->select(); ?>
                                <tr class="altbg2" onmouseover="this.className='altbg1'" onmouseout="this.className='altbg2'">
                                    <td align="center" style="border-bottom:1px dotted #EDEDED"><a href="<?php echo U(MODULE_NAME.'/User/login_log',array('username'=>$v[username]));?>"><?php echo ($v['username']); ?></a></td>
                                    <td align="center" style="border-bottom:1px dotted #EDEDED">
                                        <?php if(is_array($login)): $i = 0; $__LIST__ = $login;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i; echo ($vv['ip']); ?> <?php echo (convertip($vv['ip'])); ?> - <?php echo (date('Y-m-d H:i:s',$vv['logintime'])); endforeach; endif; else: echo "" ;endif; ?>
                                    </td>
                            ...
                            <?php if($totalPages > 1): ?><tr>
                                    <td colspan="3" align="center"><div class="pages"><?php echo ($page); ?></div> </td>
                                </tr><?php endif; ?>
                        </tbody>
                    </table>
                </div>
