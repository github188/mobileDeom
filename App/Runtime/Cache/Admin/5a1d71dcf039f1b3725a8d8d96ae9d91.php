            ...
            <div class="tab-content">
                <div id="tab_<?php echo ($gid); ?>" class="tab-pane active">
                    <div class="pull-right" style="display:block;">
                        <a  style="display:block;" class="btn btn-info" href="<?php echo U(MODULE_NAME.'/Menu/addMenu');?>" >
					...
					<table id="example" class="table table-bordered table-hover">
						...
						<tbody>
							<?php if(is_array($menu)): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
				                    <td ><?php echo ($v["id"]); ?></td>
									...
									<td>
										<a href="<?php echo U(MODULE_NAME.'/Menu/editMenu',array('mid' => $v['id']));?>" class="btn btn-primary"><i class="fa fa-pencil"></i> 修改</a>
										<a href="<?php echo U(MODULE_NAME.'/Menu/delete',array('mid' => $v['id']));?>" class="btn btn-danger delete-msg"><i class="fa fa-times"></i> 删除</a>
									</td>
