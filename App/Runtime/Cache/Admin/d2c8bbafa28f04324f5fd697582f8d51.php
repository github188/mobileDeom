                    ...
                    <table id="example" class="table table-bordered table-hover">
                        ...
                        <tbody>
                             <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="altbg2" onmouseover="this.className='altbg1'" onmouseout="this.className='altbg2'">
                                    <td align="center" style="border-bottom:1px dotted #EDEDED"><?php echo (date('Y-m-d H:i',$v["logintime"])); ?></td>
                                    <td align="center" style="border-bottom:1px dotted #EDEDED"><?php echo (convertip($v['ip'])); ?></td>
                                    <td align="center" style="border-bottom:1px dotted #EDEDED"><?php echo ($v['ip']); ?></td>
