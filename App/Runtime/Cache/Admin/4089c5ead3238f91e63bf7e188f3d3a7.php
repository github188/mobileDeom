							...
							<table id="example" class="table table-bordered">
								<tbody>
									...
									<tr>
										...
										<td><input type="text" name="name" value="<?php echo ($info['name']); ?>" class="form-control" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 购买价格：</td>
										<td><input type="text" name="buy_money" value="<?php echo ($info['buy_money']); ?>" class="form-control" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 一级提成：</td>
										<td><input type="text" name="one_money" value="<?php echo ($info['one_money']); ?>" class="form-control" size="30" ></td>
									</tr>

									<tr>
										<td class="table-td-right"> 二级提成：</td>
										<td><input type="text" name="two_money" value="<?php echo ($info['two_money']); ?>" class="form-control" size="30" ></td>
									</tr>
									<tr>
										<td class="table-td-right"> 有效期(天)：</td>
										<td><input type="text" name="gqtime" value="<?php echo ($info['gqtime']); ?>" class="form-control" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 是否允许购买：</td>
										<td>
											允许 <input type="radio" name="allow_buy" id="iCheck1" value="1" <?php echo ($info['allow_buy']==1?'checked':''); ?> > &nbsp;
											禁止 <input type="radio" name="allow_buy" id="iCheck2" value="2" <?php echo ($info['allow_buy']==2?'checked':''); ?> >
										</td>
									</tr>
									<tr>
										<td class="table-td-right"> 栏目排序：</td>
										<td><input type="text" name="sort" value="<?php echo ($info['sort']?$info['sort']:0); ?>" class="form-control" size="30"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 简介：</td>
										<td>
											<textarea name="remark" style="width: 266px;min-height: 100px;"><?php echo ($info['remark']); ?></textarea>
										</td>
									</tr>
