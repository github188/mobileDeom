...
<div class="wrapper">
			...
			<div class="col-xs-12">
				<div class="box box-info"> <!-- box-info天空蓝、 box-primary蓝色、  box-success绿色-->
					<div class="box-header nav-tabs">
						<h4 class="box-title">修改后台导航菜单</h4>
						<!-- 返回上一页 -->
	...
	<a class="btn btn-default" title="返回上一页" onclick="javascript:history.back(-1);" href="#">
		<i class="fa fa-reply"></i>
					...
					<!-- 表格开始 -->
					<div class="box-body">
						<form action="<?php echo U(MODULE_NAME.'/Menu/editMenu');?>" method="post">  
							<table id="example" class="table table-bordered">
								<tbody>
									<tr>
										<td class="table-td-right"> 菜单名称：</td>
										<td><input type="text" name="title" value="<?php echo ($menu["title"]); ?>" class="form-control" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 菜单图标：</td>
										<td><input type="text" name="attr" value="<?php echo ($menu["attr"]); ?>" class="form-control" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 显示状态：</td>
										<td>
											显示 <input type="radio" name="status" id="iCheck1" value="1" <?php if($menu['status']): ?>checked<?php endif; ?>> &nbsp;
											隐藏 <input type="radio" name="status" id="iCheck2" value="0" <?php if(!$menu['status']): ?>checked<?php endif; ?>>
										</td>
									</tr>
									<tr>
										<td class="table-td-right"> 排序：</td>
										<td><input type="text" name="sort" value="<?php echo ($menu["sort"]); ?>" class="form-control" size="30" data-rule="required;digits"></td>
									</tr>
									<tr height="60">
