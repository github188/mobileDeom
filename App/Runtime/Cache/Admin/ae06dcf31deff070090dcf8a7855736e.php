        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div id="tab_1" class="tab-pane active">
                    ...
                    <form style="margin:15px 0px 10px 0px;" class="form-inline display-inline" method="post" action="<?php echo U(MODULE_NAME.'/Video/videoPlayRecord');?>">
                    ...
                    <table id="example" class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            <?php  ?>
                             <?php if(is_array($video_play_record)): $k = 0; $__LIST__ = $video_play_record;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr>
                                        <td><?php echo ($v["id"]); ?></td>
                                        <td><?php echo ($v["video_group"]); ?></td>
                                        <td><?php echo ($v["video_title"]); ?></td>
                                        <td><?php echo ($v["username"]); ?></td>
                                        <td><?php echo (video_time_change($v["playtime"])); ?></td>
...
<script>
    ...
    function Delete(obj,id,page){
        ...
        var url = "<?php echo U(MODULE_NAME.'/Video/videoPlayRecordDelete','',true,true);?>"+'?id='+id+'&p='+page;
