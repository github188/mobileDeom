			...
			<div class="col-xs-12">
				<div class="box box-info"> <!-- box-info天空蓝、 box-primary蓝色、  box-success绿色-->
					<div class="box-header nav-tabs">
						<h4 class="box-title"><i class="fa fa-plus"></i> 添加会员分组</h4>
						<!-- 返回上一页 -->
							...
							<table id="example" class="table table-bordered">
								<tbody>
									...
									<tr>
										...
										<td><input type="text" name="buy_money" class="form-control" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 一级提成：</td>
										<td><input type="text" name="one_money" class="form-control" size="30" ></td>
									</tr>

									<tr>
										<td class="table-td-right"> 二级提成：</td>
										<td><input type="text" name="two_money" class="form-control" size="30" ></td>
									</tr>
									<tr>
										<td class="table-td-right"> 有效期(天)：</td>
										<td><input type="text" name="gqtime" class="form-control" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 是否允许购买：</td>
										<td>
											允许 <input type="radio" name="allow_buy" id="iCheck1" value="1" checked> &nbsp;
											禁止 <input type="radio" name="allow_buy" id="iCheck2" value="2" >
										</td>
									</tr>
									<tr>
										<td class="table-td-right"> 栏目排序：</td>
										<td><input type="text" name="sort" value="0" class="form-control" size="30"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 简介：</td>
										<td>
											<textarea name="remark" style="width: 266px;min-height: 100px;"></textarea>
										</td>
									</tr>

									<tr height="60">
										<td colspan="2" align="center">
											<button class="btn btn-success" type="submit"><i class="fa fa-check"></i> 添加会员分组</button>
										</td>
									</tr>
								</tbody>
							</table>
