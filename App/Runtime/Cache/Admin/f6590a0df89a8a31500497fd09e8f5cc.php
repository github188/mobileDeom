        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div id="tab_1" class="tab-pane active">
                    ...
                    <h4 align="center"><i class="fa fa-list-ul"></i> 邀请注册佣金管理</h4>
                    ...
                    <table id="example" class="table table-bordered table-hover" >
                        <thead>
                            <tr>
                                ...
                                <td align="center">被邀请用户</td>
                                <td align="center">购买课程</td>
                        ...
                        <tbody>
                            <?php  ?>
                             <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr>
                                        ...
                                        <td align="center"><?php echo ($v["username_son"]); ?></td>
                                        <td align="center"><?php echo ($v["user_group_name"]); ?></td>
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="<?php echo U(MODULE_NAME.'/Money/YongJinShenHe', array('id'=>$v['id'],'page'=>$curr_page));?>"  class="btn btn-info">
