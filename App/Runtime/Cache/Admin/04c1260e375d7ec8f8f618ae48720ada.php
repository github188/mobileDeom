        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div id="tab_1" class="tab-pane active">
                    ...
                    <form style="margin:15px 0px 10px 0px;" class="form-inline display-inline" method="post" action="<?php echo U(MODULE_NAME.'/Video/videoShoucang');?>">
                        ...
                        <div class="form-group inlineForm display-inline">
                            ...
                            <input type="text" class="form-control" name="video_title" value="<?php echo cookie('video_title');?>">
                        </div>&nbsp; &nbsp;
                    ...
                    <table id="example" class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            <?php  ?>
                             <?php if(is_array($video_shoucang)): $k = 0; $__LIST__ = $video_shoucang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr>
                                        <td><?php echo ($v["id"]); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="videoShoucangDelete(this,<?php echo ($v['id']); ?>,<?php echo ($curr_page); ?>)" href="javascript:;" class="btn btn-danger">
                                                <i class="fa fa-remove"></i>删除
                                            </a>
                                        </td>
                                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>

                            <?php if(!$video_shoucang): ?><tr>
...
<script>
    ...
    function videoShoucangDelete(obj,id,page){
        ...
        var url = "<?php echo U(MODULE_NAME.'/Video/videoShoucangDelete','',true,true);?>"+'?id='+id+'&p='+page;
