            ...
            <div class="tab-content">
                <div id="tab_1" class="tab-pane active">
                    ...
                    <table id="example" class="table table-bordered table-hover" align="center" cellpadding="4" cellspacing="1" width="100%">
                        <tbody>
                          <tr class="header">
                            <td bgcolor="#F8F8F8" colspan="2"><?php echo ($position_name); ?></td>
                          </tr>
                           <tr>
                            <td  width="34%">会员分组名称:</td>
                            <td  width="66%">
                            <input name="info[name]" type="text" value=""></td>
                          </tr>
                          <tr>
                            <td  width="34%">过期时间:</td>
                            <td  width="66%">
                            <input name="info[gqtime]" type="text" value=""></td>
                          </tr>
                          <tr>
                            <td  width="34%">一级提成:</td>
                            <td  width="66%">
                            <input name="info[tg_money]" type="text" value=""></td>
                          </tr>
                                              <tr>
                            <td  width="34%">二级提成:</td>
                            <td  width="66%">
                            <input name="info[tg_money_2]" type="text" value=""></td>
                          </tr>
                                              <tr>
                            <td  width="34%">是否允许自助开通权限:</td>
                            <td  width="66%">
                            <input name="info[allow_buy]" type="radio" value="1" >是
                            <input name="info[allow_buy]" type="radio" value="0" >否
                            </td>
                          </tr>
                                              <tr>
                            <td  width="34%">购买价格:</td>
                            <td  width="66%">
                            <input name="info[buy_price]" type="text" value=""></td>
                          </tr>
                        </tbody>
                    </table>
                     <br>
