            ...
            <div class="tab-content">
                <div id="tab_<?php echo ($gid); ?>" class="tab-pane active">
                    ...
                    <div class="pull-right" style="display:block;">
                        <a  style="display:block;" class="btn btn-info" href="<?php echo U(MODULE_NAME.'/User/userGroupAdd');?>" >
                    ...
                    <form action="" method='post'>
                        ...
                        <table id="example" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($user_group)): $k = 0; $__LIST__ = $user_group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr>
                                        <td><?php echo ($v["id"]); ?></td>
                                        <td><img src="/Public/Static/images/user_group/<?php echo ($v["id"]); ?>.png" alt=""><b><?php echo ($v["name"]); ?></b></td>
                                        <td><?php echo ($v["one_money"]); ?></td>
                                        <td><?php echo ($v["two_money"]); ?></td>
                                        <td><?php echo ($v["gqtime"]); ?></td>
                                        <td><?php echo ($v['allow_buy']==1?'允许':'禁止'); ?></td>
                                        <td><b style="color: #f8352e"><?php echo ($v['buy_money']); ?></b></td>
                                        <td>
                                            <?php $curr_page = I('get.p',1,'intval'); ?>

                                            <a href="<?php echo U(MODULE_NAME.'/User/userGroupEdit', array('group_id'=>$v['id'],'page'=>$curr_page));?>" class="btn btn-primary">
                                                <i class="fa fa-pencil"></i>编辑
                                            </a>
                                            <?php if(1): ?><a onclick="videoGroupDelete(this,<?php echo ($v['id']); ?>,<?php echo ($pid); ?>,<?php echo ($curr_page); ?>)" href="javascript:;" class="btn btn-danger">
                                                    <i class="fa fa-remove"></i>删除
                                                </a><?php endif; ?>
                                        </td>
                                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php if(!$user_group): ?><tr>
