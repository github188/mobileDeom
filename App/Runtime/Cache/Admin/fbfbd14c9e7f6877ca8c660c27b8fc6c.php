...
<div class="wrapper">
	...
	<a class="btn btn-default" title="返回上一页" onclick="javascript:history.back(-1);" href="#">
		<i class="fa fa-reply"></i>
					...
					<!-- 表格开始 -->
					<div class="box-body">
						<form action="<?php echo U(MODULE_NAME.'/Rbac/editRole');?>" method="post">  
							<table id="example" class="table table-bordered">
								<tbody>
									<tr>
										<td class="table-td-right"> 角色名称：</td>
										<td><input type="text" name="name" value="<?php echo ($role["name"]); ?>" class="form-control" size="30" data-rule="required"> &nbsp; (*英文名称)</td>
									</tr>
									<tr>
										<td class="table-td-right"> 角色描述：</td>
										<td><input type="text" name="remark" value="<?php echo ($role["remark"]); ?>" class="form-control" size="30" data-rule="required"> &nbsp; (*中文描述)</td>
									</tr>
									<tr>
										<td class="table-td-right"> 开启状态：</td>
										<td>
						                    开启 <input type="radio" name="status" id="iCheck1" value="1" <?php if($role['status']): ?>checked<?php endif; ?>> &nbsp;
						                    关闭 <input type="radio" name="status" id="iCheck2" value="0" <?php if(!$role['status']): ?>checked<?php endif; ?>>
										</td>
									</tr>
									<tr height="60">
