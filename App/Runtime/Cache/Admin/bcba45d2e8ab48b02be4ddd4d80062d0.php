			...
			<div class="col-xs-12">
				<div class="box box-info"> <!-- box-info天空蓝、 box-primary蓝色、  box-success绿色-->
					<div class="box-header nav-tabs">
						<h4 class="box-title"><i class="fa fa-plus"></i> 添加会员黑名单</h4>
						<!-- 返回上一页 -->
							...
							<table id="example" class="table table-bordered">
								<tbody>
									...
									<tr>
										...
										<td><input type="text" disabled value="<?php echo ($user_info['username']); ?>" name="" class="form-control" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 开始时间：</td>
										<td><input type="text" name="start_time" class="date-time" size="30" data-date-format="yyyy-mm-dd" value="<?php echo ($hack_info['start_time']?date('Y-m-d',$hack_info['start_time']):''); ?>"><td>
									</tr>
									<tr>
										<td class="table-td-right"> 结束时间：</td>
										<td><input type="text" name="end_time" class="date-time" size="30" data-date-format="yyyy-mm-dd" value="<?php echo ($hack_info['end_time']?date('Y-m-d',$hack_info['end_time']):''); ?>"><td>
									</tr>

									<tr>
										<td class="table-td-right"> 拉黑理由：</td>
										<td>
											<textarea data-rule="required" name="remark" style="width: 266px;min-height: 100px;"><?php echo html_entity_decode($hack_info['remark']);?></textarea>
										</td>
									</tr>
