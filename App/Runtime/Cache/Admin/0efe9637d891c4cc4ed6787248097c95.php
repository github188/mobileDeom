...
<div class="wrapper">
	...
	<a class="btn btn-default" title="返回上一页" onclick="javascript:history.back(-1);" href="#">
		<i class="fa fa-reply"></i>
					...
					<!-- 表格开始 -->
					<div class="box-body">
						<form action="<?php echo U(MODULE_NAME.'/Article/addArticle');?>" method="post">  
							<table id="example" class="table table-bordered">
								<tbody>
									<tr>
										<td class="table-td-right"> 文章标题：</td>
										<td><input type="text" name="title" class="form-control" size="50" data-rule="required"></td>
									</tr>
									<tr>
										...
										<td>
			                                <select class="form-control inlineSelect" name="category_id" data-rule="required">
			                                    ...
			                                    <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><option value="<?php echo ($v['id']); ?>" <?php if($v['level'] == 1): ?>disabled="disabled"<?php endif; ?> ><?php echo ($v['html']); ?> <?php echo ($v['name']); ?></option><?php endforeach; endif; ?>
			                                </select>
										</td>
									</tr>
									<tr>
										<td class="table-td-right"> SEO关键字：</td>
										<td><input type="text" name="seo_keyword" class="form-control" size="50"> 多个关键词以( 、 )分隔</td>
									</tr>
									<tr>
										<td class="table-td-right"> SEO描述：</td>
										<td><input type="text" name="seo_description" class="form-control" size="50"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
										<textarea name="content" id="editor_content" style="width:95%;" data-rule="required"></textarea>
										</td>
									</tr>
									<tr height="60">
										<td colspan="2" align="center">
											<button class="btn btn-success" type="submit"><i class="fa fa-check"></i> 确定添加文章</button>
										</td>
									</tr>
								</tbody>
							</table>
