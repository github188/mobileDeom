                            ...
                            <table id="example" class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo (getParentCateName($arr["category_id"])); ?> <?php echo (getCateName($arr["category_id"])); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="table-td-right"> SEO关键字：</td>
                                        <td><?php echo ($arr["seo_keyword"]); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="table-td-right"> SEO描述：</td>
                                        <td><?php echo ($arr["seo_description"]); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="table-td-right"> 显示状态：</td>
                                        <td><?php if(!$arr['status']): ?>显示<?php else: ?>隐藏<?php endif; ?> </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo (date("Y-m-d H:i:s",$arr["savetime"])); ?> </td>
                                    </tr>
                                    <tr height="60">
                                    ...
                                    <tr >
                                        <td colspan="2">
                                            <div style="width: 1100px;"><?php echo (htmlspecialchars_decode($arr["content"])); ?></div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
