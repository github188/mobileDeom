...
<div class="wrapper">
	...
	<a class="btn btn-default" title="返回上一页" onclick="javascript:history.back(-1);" href="#">
		<i class="fa fa-reply"></i>
					...
					<!-- 表格开始 -->
					<div class="box-body">
						<form action="<?php echo U(MODULE_NAME.'/Rbac/addUser');?>" method="post">  
							<table id="example" class="table table-bordered">
								<tbody>
									<tr>
										<td class="table-td-right"> 用户名：</td>
										<td><input type="text" name="user" class="form-control" size="30" data-rule="required;username"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 登录密码：</td>
										<td><input type="password" name="pass" class="form-control" size="30" data-rule="required;password"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
						                    男 <input type="radio" name="sex" id="iCheck1" value="0" checked> &nbsp;
						                    女 <input type="radio" name="sex" id="iCheck2" value="1" >
										</td>
									</tr>
									<tr>
										<td class="table-td-right"> Email邮箱：</td>
										<td><input type="text" name="email" value="" class="form-control" size="30" data-rule="email"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 手机号码：</td>
										<td><input type="text" name="tel" class="form-control" size="30" data-rule="mobile"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 锁定状态：</td>
										<td>
						                    正常 <input type="radio" name="lock" id="iCheck1" value="0" checked> &nbsp;
						                    锁定 <input type="radio" name="lock" id="iCheck2" value="1">
										</td>
									</tr>
									<tr height="80">
										<td class="table-td-right"> 所属角色：</td>
										<td>
						                    <select name="role_id" data-rule="required">
