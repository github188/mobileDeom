...
<div class="wrapper">
			...
			<div class="col-xs-12">
				<div class="box box-info"> <!-- box-info天空蓝、 box-primary蓝色、  box-success绿色-->
					<div class="box-header nav-tabs">
						<h4 class="box-title"><i class="fa fa-pencil"></i> 修改栏目分类</h4>
						<!-- 返回上一页 -->
	...
	<a class="btn btn-default" title="返回上一页" onclick="javascript:history.back(-1);" href="#">
		<i class="fa fa-reply"></i>
					...
					<!-- 表格开始 -->
					<div class="box-body">
						<form action="<?php echo U(MODULE_NAME.'/Category/editCate');?>" method="post">  
							<table id="example" class="table table-bordered">
								<tbody>
									<tr>
										<td class="table-td-right"> 栏目名称：</td>
										<td><input type="text" name="name" value="<?php echo ($cate["name"]); ?>" class="form-control" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 显示状态：</td>
										<td>
											显示 <input type="radio" name="status" id="iCheck1" value="0" <?php if(!$cate['status']): ?>checked<?php endif; ?>> &nbsp;
											隐藏 <input type="radio" name="status" id="iCheck2" value="1" <?php if($cate['status']): ?>checked<?php endif; ?>>
										</td>
									</tr>
									<tr>
										<td class="table-td-right"> 栏目排序：</td>
										<td><input type="text" name="sort" value="<?php echo ($cate["sort"]); ?>" class="form-control" size="30" data-rule="required;digits"></td>
									</tr>

									<tr height="60">
										<td colspan="2" align="center">
											<input type="hidden" name="cid" value="<?php echo ($cate["id"]); ?>">
