...
<div class="wrapper">
			...
			<div class="col-xs-12">
				<div class="box box-info">
					<div class="box-header nav-tabs">
						<h4 class="box-title">修改网站配置参数</h4>
						<!-- 返回上一页 -->
	...
	<a class="btn btn-default" title="返回上一页" onclick="javascript:history.back(-1);" href="#">
		<i class="fa fa-reply"></i>
					...
					<!-- 表格开始 -->
					<div class="box-body">
						<form action="<?php echo U(MODULE_NAME.'/Config/index');?>" method="post">  
							<table id="example" class="table table-bordered">
								<tbody>
									<tr>
										<td class="table-td-right"> 网站名称：</td>
										<td><input type="text" name="web_name" class="form-control" value="<?php echo ($arr["web_name"]); ?>" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> 网站域名：</td>
										<td><input type="text" name="web_domain" class="form-control" value="<?php echo ($arr["web_domain"]); ?>" size="30" data-rule="required"></td>
									</tr>
									<tr>
										<td class="table-td-right"> web开放状态：</td>
										<td>
						                    开启 <input type="radio" name="web" id="iCheck1" value="0" <?php if(!$arr['web']): ?>checked<?php endif; ?>> &nbsp;
						                    关闭 <input type="radio" name="web" id="iCheck2" value="1" <?php if($arr['web']): ?>checked<?php endif; ?>>
										</td>
									</tr>
									<tr>
										<td class="table-td-right"> 前台开放注册状态：</td>
										<td>
						                    开启 <input type="radio" name="register" id="iCheck1" value="0" <?php if(!$arr['register']): ?>checked<?php endif; ?>> &nbsp;
						                    关闭 <input type="radio" name="register" id="iCheck2" value="1" <?php if($arr['register']): ?>checked<?php endif; ?>>
										</td>
									</tr>
									<tr>
										<td class="table-td-right"> PC文章底部广告：</td>
										<td>
						                    <textarea name="article_ad" rows="10" cols="100"><?php echo (htmlspecialchars_decode($arr["article_ad"])); ?></textarea>
										</td>
									</tr>
									<tr>
										<td class="table-td-right"> WAP文章底部广告：</td>
										<td>
						                    <textarea name="article_ad_wap" rows="10" cols="100"><?php echo (htmlspecialchars_decode($arr["article_ad_wap"])); ?></textarea>
										</td>
									</tr>
									<tr>
										<td class="table-td-right"> 最后修改时间：</td>
										<td>
											<?php echo (date('Y-m-d H:i:s',$arr["save_time"])); ?>
										</td>
									</tr>
									<tr height="60">
