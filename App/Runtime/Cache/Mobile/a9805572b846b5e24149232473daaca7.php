...
<section class="myContactUs notice">
    ...
    <a href="javascript:;" class="tp">
        ...
        <div class="tab">
            <ol>
                <li class="li01"><a href="<?php echo U('Content/webNoticeList');?>">平台公告</a></li>
                <li class="li02 cur"><a href="<?php echo U('Content/goodShareList');?>">干货分享</a></li>
            ...
            <div class="module">
                <ul>
                    <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><li>
                            <a href="<?php echo U('Content/goodShare',array('main'=>$v['id']));?>">
                                <div class="tp">
