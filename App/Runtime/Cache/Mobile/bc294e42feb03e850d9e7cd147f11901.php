...
<section class="findPwd">
    <div class="in">
        <div class="withRate">
            <div class="tp">
                <img src="/Public/Mobile/images/rate03.png">
            </div>
            <div class="txt">
                <div class="tx01 cur">
                    <span>验证方式</span>
        ...
        <div class="sucTip">
            <div class="tp">
                <img src="/Public/Mobile/images/sucIcoS.png">
            </div>
            <p class="ti">您已设置密码成功</p>
        </div>
        <div class="botLink botLink02">
            <p>1.您的密码已设置成功，使用新密码，<a href="<?php echo U('Login/index');?>" class="link">重新登录&gt;&gt;</a></p>
            <p>2.如您不能正常登录，请及时联系<a href="javascript:;" class="link">在线客服</a>解决。</a></p>
        </div>
    </div>
</section>
