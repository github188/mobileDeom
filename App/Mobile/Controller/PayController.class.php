...
class PayController extends CommonController {
    ...
    public function payWeixin(){
        ...
        // if(IS_POST){
            ...
            //获取用户openid
            $tools = new JsApiPay();
            // $jumpUrl = U('Pay/payWeixin', array('trade_no' => $trade_no, 'money' => $money));
            $openId = $tools->GetOpenid('/jspayWeixinWap?trade_no='.$trade_no.'&money='.$money);
            ...
            $input->SetGoods_tag("");
            $input->SetNotify_url($public_domain_name.$config['notify_url_wap']);
