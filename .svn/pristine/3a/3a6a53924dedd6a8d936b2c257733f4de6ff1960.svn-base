...
function _init() {
    ...
    $.AdminLTE.layout = {
        ...
        fix: function () {
            ...
            // console.log("c="+c);
            // console.log("a="+a);
            if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight()); //修改高度
            else {
                var d;
				...
				var h=b >= c?(b-c)+a:c+b+a;
				
				// console.log(window.screen.height);
					/*$("#rightContent").load(function(){
						var mainheight = $(this).contents().find("body").height()+20;
						console.log(mainheight);
						//$("#riframe").height(mainheight+a);//浏览器当前窗口可视区域高度
						$("#rightContent").contents().find(".box-body").slimScroll({
                height: (mainheight+a) + "px",
                color: "rgba(0,0,0,0.2)",
                size: "3px"
            });
					});*/
				// console.log($(".sidebar-menu").height());
