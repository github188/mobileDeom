...
class ArticleOtherController extends CommonController
{
//    文章类型
...
//        print_r($request);die;
    ...
    public function addArticle () {
        ...
        if (IS_POST) {
            ...
            if ($this->db->add($data)) {
                $this->success('添加成功!', U(MODULE_NAME.'/ArticleOther/index'));
            }else{
                $this->error('添加失败!');
            }
...
//        $db = M('ArticleOther');
        if (IS_POST) {
            ...
            if ($this->db->where(array('id' => $aid))->save($data)) {
                $this->success('修改成功!', U(MODULE_NAME.'/ArticleOther/index'));
            }else{
    ...
    public function delArticle () {
        ...
        if ($this->db->where(array('id' => $aid))->delete()) {
            $this->success('删除成功!' ,U(MODULE_NAME.'/ArticleOther/index'));
        }else{
            $this->error('删除失败!');
        }
    }
